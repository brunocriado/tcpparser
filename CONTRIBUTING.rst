...
Welcome to ``tcpparser`` contributor's guide.
...
If you experience bugs or general issues with ``tcpparser``, please have a look
...
You can help improve ``tcpparser`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``tcpparser`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``tcpparser``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n tcpparser python=3 six virtualenv pytest pytest-cov
    conda activate tcpparser
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/tcpparser.git
    cd tcpparser
...
#. Install |pre-commit|_::
   ...
   ``tcpparser`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/tcpparser
.. _issue tracker: https://github.com/<USERNAME>/tcpparser/issues
.. <-- end -->
